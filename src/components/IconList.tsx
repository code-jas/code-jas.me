...
const IconCard = ({ iconSlugs }: IconCardProps) => {
   ...
   return (
      <div className="space-y-4">
         ...
         <div className="pointer-events-none absolute inset-y-0 left-0 w-1/3 bg-gradient-to-r from-surface-2 dark:from-background"></div>
         <div className="pointer-events-none absolute inset-y-0 right-0 w-1/3 bg-gradient-to-l from-surface-2 dark:from-background"></div>
      </div>
   );
};
